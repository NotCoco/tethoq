...
} satisfies Parameters<typeof parseConnectorManifest>[0]) as ConnectorManifestV1;
...
async function broadcast(emit: (subscriptionId: string, event: ConnectorEvent) => Promise<void>, event: ConnectorEvent): Promise<void> {
