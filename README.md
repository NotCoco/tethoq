...
The dashboard and chat below were captured from the Android app running in an emulator with synthetic demo data.

| Mobile dashboard | Chat and approvals |
| --- | --- |
| <img src="docs/media/tethoq-mobile-dashboard.png" alt="Tethoq Android dashboard with fictional tasks across Codex, OpenCode, and Grok Build" width="360" /> | <img src="docs/media/tethoq-mobile-chat.png" alt="Tethoq Android chat showing a fictional landing-page task and its deployment approval" width="360" /> |
| Follow active tasks across your coding agents. | Read the conversation, review an approval, and send a follow-up from your phone. |

### Pair your phone

Open Tethoq Bridge on Windows, choose **Pair a phone**, then choose **Scan QR code** in the mobile app.

<img src="docs/media/tethoq-phone-pairing.png" alt="Tethoq Bridge displaying a nonfunctional demo QR code for phone pairing" width="360" />

The QR code pictured here is a nonfunctional demo. Use the code generated by your own Tethoq Bridge to pair a phone.

All product images use fictional projects, paths, and conversations from isolated demo fixtures; no live user sessions, credentials, or pairing invitations are present.
